const _settings = {
  ...
  modelQuaternion: new THREE.Quaternion().setFromEuler(new THREE.Euler(Math.PI/2, 0, Math.PI / 4)).toArray(), // 90 degrees around Z-axis
...
function main(){
  ...
  HandTrackerThreeHelper.init({
    ...
    console.error('Error initializing HandTrackerThreeHelper:', err);
  });
} 
